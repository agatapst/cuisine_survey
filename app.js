...
new Vue({
    ...
    data: {
        types: [
            ...
            {name: 'spanish', desc: 'paella, jamon', votes: '0', imageUrl: 'https://images.unsplash.com/photo-1512058466835-da4d54fb0ee8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=960&q=80.jpg'},
            ...
            {name: 'chinese', desc: 'bao ze, noodle', votes: '0', imageUrl: 'https://images.unsplash.com/photo-1550303659-a777c03a27bd?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80.jpg'},
       ],
    },

    methods: {
        addPoint: function(type) {
          console.log("point added: " + type.name)
          type.votes++;
        }
